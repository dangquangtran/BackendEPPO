...
namespace BackendEPPO.Extenstion
{
    public class ApiEndPointConstant
    {
        ...
        public static class Contract
        {
            ...
            public const string CreateContractv2 = GetListContract_Endpoint + "/Create/CreateContractv2";
        ...
        public static class OrderRental
        {
            ...
            public const string UpdateReturnOrderRental = ApiEndpoint + "/GetList/OrderRental/Update/Return/Id";
        }
